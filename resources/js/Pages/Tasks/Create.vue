...
// local reactive copy so we can push new projects
...
const createProject = () => {
    projectForm.post(route('projects.store', { return_back: 1 }), {
        preserveScroll: true,
        onSuccess: () => {
            // Inertia refreshes the page props — but since we preserve scroll
            // we manually fetch and push the new project.
            // Instead, just reload projects from the server silently.
                    ...
                    <div class="p-6 text-gray-100">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center justify-end gap-4">
                                <Link :href="route('tasks.index')" class="text-sm text-gray-400 hover:text-gray-300">
                                    Cancel
                                </Link>
