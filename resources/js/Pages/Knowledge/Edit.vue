...
<template>
    ...
    <AuthenticatedLayout>
            ...
            <div class="flex items-center gap-4">
                <Link :href="route('documents.show', document.id)" class="text-gray-400 hover:text-gray-100 transition-colors">
                    ...
                    <div class="p-6 text-gray-100">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                <Link
                                    :href="route('documents.destroy', document.id)"
                                    method="delete"
                                    as="button"
                                ...
                                <div class="flex gap-4">
                                    <Link :href="route('documents.show', document.id)" class="text-sm text-gray-400 hover:text-gray-300 mt-2">
                                        Cancel
                                    </Link>
