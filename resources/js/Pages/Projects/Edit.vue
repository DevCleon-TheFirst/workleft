...
<template>
    ...
    <AuthenticatedLayout>
            ...
            <div class="flex items-center gap-4">
                <Link :href="route('projects.show', project.id)" class="text-gray-400 hover:text-gray-100 transition-colors">
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex gap-4">
                                    <Link :href="route('projects.show', project.id)" class="text-sm text-gray-400 hover:text-gray-300 mt-2">
                                        Cancel
                                    </Link>
